...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'devops_volume', 'node_control',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='volumes', null=True, to=orm['devops.NodeControl']),
                      keep_default=False)
    ...
    models = {
        ...
        u'devops.volume': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'node_control': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'volumes'", 'null': 'True', 'to': u"orm['devops.NodeControl']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        }
    }
